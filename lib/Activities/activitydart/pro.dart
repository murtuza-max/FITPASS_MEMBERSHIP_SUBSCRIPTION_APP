...
import 'package:flutter_auth/Activities/Screen/calisthenics_list_screen.dart';
import 'package:flutter_auth/Activities/Screen/pilates_list_screen.dart';
import 'package:flutter_auth/Activities/Screen/progyms_list_screen.dart';
...
class _ProState extends State<Pro> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("PRO MEMBERSHIP"),),
       body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/prio-ms.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Container(
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/images/pro-s1.jpg'),
          fit: BoxFit.cover,
        ),
      ),
      child: Container(
  ...
  Widget buildProClubs() => Card(
    ...
    child: Stack(
      ...
      children: [
        Ink.image(
          image: AssetImage(
            'assets/images/pr-clb.jpg',
          ),
          //colorFilter: ColorFilters.greyscale,
          child: InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>ProgymsListScreen()));
            },
          ),
          height: 120,
          fit: BoxFit.fill,
  ...
  Widget buildCalisthenicsClass() => Card(
    clipBehavior: Clip.antiAlias,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(24),
    ),
    child: Stack(
      ...
      children: [
        Ink.image(
          image: AssetImage(
            'assets/images/cstd.jpg',
          ),
          //colorFilter: ColorFilters.greyscale,
          child: InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>CalisthenicsListScreen()));
            },
          ),
          height: 120,
          fit: BoxFit.fill,
  ...
  Widget buildPilatesClass() => Card(
    ...
    child: Stack(
      ...
      children: [
        Ink.image(
          image: AssetImage(
            'assets/images/p-std.jpg',
          ),
          //colorFilter: ColorFilters.greyscale,
          child: InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>PilatesListScreen()));
            },
          ),
          height: 120,
          //width: 200,
