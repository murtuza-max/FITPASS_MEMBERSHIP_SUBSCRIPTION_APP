...
//lib>screens>floorworkouts_details_screen.dart

class FloorworkoutsDetailsScreen extends StatelessWidget {
  final Floorworkouts gym;

  FloorworkoutsDetailsScreen(this.gym);
