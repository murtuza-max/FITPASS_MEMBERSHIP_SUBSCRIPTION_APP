...
//lib>screens>premiumgyms_details_screen.dart

class PremiumgymsDetailsScreen extends StatelessWidget {
  final PremiumGym gym;
  var clubname;
  PremiumgymsDetailsScreen(this.gym,this.clubname);
