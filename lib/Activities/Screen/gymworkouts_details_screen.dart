...
//lib>screens>gymworkouts_details_screen.dart

class GymworkoutsDetailsScreen extends StatelessWidget {
  final Gymworkouts gym;

  GymworkoutsDetailsScreen(this.gym);
