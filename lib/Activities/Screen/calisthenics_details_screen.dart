...
//lib>screens>calisthenics_details_screen.dart

class CalisthenicsDetailsScreen extends StatelessWidget {
  final Calisthenics gym;
  var clubname;
  CalisthenicsDetailsScreen(this.gym,this.clubname);
